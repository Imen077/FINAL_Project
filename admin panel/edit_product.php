<?php
 ...
 if(isset($_POST['update'])){
    ...
    $update_product = $conn->prepare("UPDATE `product` SET name = ?, price = ?, 
    product_detail = ?, stock = ?, status = ?, WHERE id = ?");
            ...
            <div class="form-container">
                <form action="" method="post" enctype="multipart/form-data" class="register">
                    ...
                    <div class="input-field">
                       ...
                       <textarea name="description" class="box"><?= $fetch_product['product-detail']; ?></textarea>
                    </div>
                    <div class="input-field">
                    ...
                    <div class="input-field">
                       ...
                       <?php if($fetch_product['image'] != ''){ ?>
                        ...
                        <div class="flex-btn">
                            ...
                            height: 3rem; margin-top: 3rem;">go back</a>
                        </div>
                        <?php } ?>
                     </div>
                      <div class="flex-btn">
