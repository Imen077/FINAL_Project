...
<body>
   ...
   <section class="dashboard">
       ...
       <div class="box-container">
         ...
         <div class="box">
            <?php
            $select_confrim_orders = $conn->prepare("SELECT * FROM `orders` WHERE seller_id = ? AND status = ?");
            $select_confrim_orders->execute([$seller_id, 'in progress']);
            $number_of_confrim_orders = $select_confrim_orders->rowCount();
            ?>
            <h3><?= $number_of_confrim_orders; ?></h3>
            <p>total confrim orders placed</p>
            <a href="admin_order.php" class="btn">confrim orders</a>
         </div>
         <div class="box">
            <?php
